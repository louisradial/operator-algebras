...
Let \(\algebra{A}\) be a Banach *-algebra and let \(\algebra{I}\subset \algebra{A}\) be a \todo[non-trivial] closed *-ideal of \(\algebra{A}\). We'll show that with the maps
\begin{align*}
...
\begin{proof}
    ...
    Let \(\family{[x_n]}{n \in \mathbb{N}} \subset \algebra{A}/\algebra{I}\) be a sequence in \(\algebra{A}/\algebra{I}\). For all \(n,m,p \in \mathbb{N}\) \todo[there exists] \(\ell(n,m,p) \in \algebra{I}\) satisfying
    \begin{equation*}
        \norm{x_m - x_n + \ell(m,n,p)} \leq \norm{[x_m] - [x_n]} + \frac{1}{2^{p+1}}.
    \end{equation*}
    We now suppose the sequence is Cauchy, then for all \(\varepsilon> 0\) there exists \(N_{\varepsilon} > 0\) such that for all \(m, n > N_{\varepsilon}\) we have \(\norm{[x_m] - [x_n]} < \varepsilon\). Then, \todo[we may choose] a subsequence \(\family{[x_{i_j}]}{j \in \mathbb{N}}\) satisfying
    \begin{equation*}
...
\begin{theorem}{Quotient space of a Banach *-algebra by a closed *-ideal}{closed_ideal_Bstar}
    Let \(\algebra{A}\) be a Banach *-algebra. If \(\algebra{I}\) is a \todo[non-trivial] closed *-ideal of \(\algebra{A}\), then \(\algebra{A}/\algebra{I}\) is a Banach *-algebra.
\end{theorem}
\begin{proof}
