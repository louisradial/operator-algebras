...
\begin{lemma}{Union and intersection of preimages}{union_intersection_preimage}
    Let \(X\) and \(Y\) be non-empty sets. If \(\mathfrak{V} \subset \power{Y}\) is a non-empty collection of subsets of \(Y\), then
    \begin{equation*}
        \preim{f}{\bigcup \mathfrak{V}} = \bigcup_{V \in \mathfrak{V}} \preim{f}{V}
        \quad\text{and}\quad
        \preim{f}{\bigcap \mathfrak{V}} = \bigcap_{V \in \mathfrak{V}} \preim{f}{V}
    \end{equation*}
...
\begin{proof}
    We have
    \begin{align*}
        \preim{f}{\bigcup \mathfrak{V}} &= \setc*{x \in X}{f(x) \in \bigcup_{V \in \mathfrak{V}} V}&
        \preim{f}{\bigcap \mathfrak{V}} &= \setc*{x \in X}{f(x) \in \bigcap_{V \in \mathfrak{V}} V}\\
                                        &= \setc*{x \in X}{\exists V \in \mathfrak{V} : f(x) \in V}&
                                        &= \setc*{x \in X}{\forall V \in \mathfrak{V} : f(x) \in V}\\
                                        &= \bigcup_{V \in \mathfrak{V}} \setc{x \in X}{f(x) \in V}&
                                        &= \bigcap_{V \in \mathfrak{V}} \setc{x \in X}{f(x) \in V}\\
                                        &= \bigcup_{V \in \mathfrak{V}} \preim{f}{V}&
                                        &= \bigcap_{V \in \mathfrak{V}} \preim{f}{V},
    \end{align*}
    as claimed.
\end{proof}
...
\end{proposition}
\begin{proof}
    Clearly, we have \(X = \preim{f}{Y}\) and \(\emptyset = \preim{f}{\emptyset}\), hence \(X, \emptyset \in \tau_X\). Let \(\mathfrak{U} \subset \tau_X\) be a non-empty collection of sets in \(\tau_X\). For each \(U \in \mathfrak{U}\), there exists \(V_U \in \tau_{Y}\) such that \(U = \preim{f}{V_U}\), hence
    \begin{align*}
        \bigcup \mathfrak{U} &= \bigcup_{U \in \mathfrak{U}} \preim{f}{V_U}&
        \bigcap \mathfrak{U} &= \bigcap_{U \in \mathfrak{U}} \preim{f}{V_U}\\
                             &= \preim{f}{\bigcup_{U \in \mathfrak{U}} V_U}&
                             &= \preim{f}{\bigcap_{U \in \mathfrak{U}} V_U}
    \end{align*}
    by \cref{lem:union_intersection_preimage}. Since \(\tau_Y\) is a topology, we immediately have \(\bigcup_{U \in \mathfrak{U}} V_U \in \tau_Y\), therefore \(\bigcup \mathfrak{U} \in \tau_X\). If, in addition, \(\mathfrak{U}\) is finite, we have \(\bigcap \mathfrak{U} \in \tau_X\) by the same argument.
...
\end{proposition}
\begin{proof}
    Since \(X = \preim{f}{Y}\) and \(\emptyset = \preim{f}{\emptyset}\), we have \(Y,\emptyset \in \tau_Y\). Let \(\mathfrak{V} \subset \tau{Y}\) be a non-empty collection of sets in \(\tau_Y\), then by \cref{lem:union_intersection_preimage} we have \(\preim{f}{\bigcup \mathfrak{V}}= \bigcup_{V \in \mathfrak{V}}\preim{f}{V}\) and \(\preim{f}{\bigcap \mathfrak{V}} = \bigcap_{V \in \mathfrak{V}} \preim{f}{V}\). For each \(V \in \mathfrak{V}\), we have \(\preim{f}{V} \in \tau_X\), therefore \(\preim{f}{\bigcup \mathfrak{V}} \in \tau_X\) and we conclude \(\bigcup \mathfrak{V} \in \tau_Y\). If \(\mathfrak{V}\) is finite, we also have \(\preim{f}{\bigcap \mathfrak{V}} \in \tau_X\), hence \(\bigcap \mathfrak{V} \in \tau_Y\).
\end{proof}

\begin{proposition}{Initial topology}{initial_topology}
    Let \(X\) be a non-empty set and let \(\mathfrak{Y} = \family{\topology{Y_i}}{i\in I}\) be a collection of topological spaces, with some arbitrary indexing set \(I\), where we consider the collection \(\mathfrak{F}\) of maps \(f_i : X \to Y_i\), for all \(i \in I\). For each \(i \in I\), the set
    \begin{equation*}
        \tau_{i} = \setc{U \in \power{X}}{\exists V \in \tau_{Y_i} : U = \preim{f_i}{V}}
    \end{equation*}
    is a topology on \(X\). The \emph{initial topology \(\tau_X\) on \(X\) with respect to the collections \(\mathfrak{Y}\) and \(\mathfrak{F}\)} is the topology on \(X\) defined by
    \begin{equation*}
        \tau_X = \bigcap_{i \in I} \tau_i,
    \end{equation*}
    and has the property that every map \(f \in \mathfrak{F}\) is continuous.
\end{proposition}
\begin{proof}
